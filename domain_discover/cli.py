...
def run_domain_discovery(args):
    ...
    wordnet_conditioner = WordNetConditioner(init_method='wordnet', black_model=black_box, max_words=5000, min_words_per_category=20, initial_sentence_from_wordnet=True).to(device)
